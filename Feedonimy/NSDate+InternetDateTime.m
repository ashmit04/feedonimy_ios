...
+ (NSDate *)dateFromRFC822String:(NSString *)RFC822String {
	...
	if ([RFC822String rangeOfString:@","].location != NSNotFound) {
		if (!date) { // Sun, 19 May 2002 15:21:36 GMT Thu, 28 Aug 2014 16:00:00 +0000
	...
	if (!date) NSLog(@"Could not parse RFC822 date: \"%@\" Possibly invalid format.", RFC822String);
	return date;
